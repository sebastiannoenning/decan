...
"}")
        ...
        self.event_header = QWidget(self.events_view)
        self.event_header.setObjectName(u"event_header")
        sizePolicy2 = QSizePolicy(QSizePolicy.Policy.MinimumExpanding, QSizePolicy.Policy.Maximum)
        sizePolicy2.setHorizontalStretch(0)
        sizePolicy2.setVerticalStretch(0)
        sizePolicy2.setHeightForWidth(self.event_header.sizePolicy().hasHeightForWidth())
        self.event_header.setSizePolicy(sizePolicy2)
        self.event_header.setMinimumSize(QSize(312, 40))
        self.event_header.setMaximumSize(QSize(350, 40))

        self.events_view_container.addWidget(self.event_header)
        ...
        self.event_list.setGeometry(QRect(0, 0, 348, 408))
...
"}")
        ...
        icon = QIcon()
        icon.addFile(u":/icons/util/add_1_dark.svg", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        icon.addFile(u":/icons/util/add_2_red.svg", QSize(), QIcon.Mode.Active, QIcon.State.Off)
        icon.addFile(u":/icons/util/add_2_red.svg", QSize(), QIcon.Mode.Active, QIcon.State.On)
        self.add_event_button.setIcon(icon)
...
"}")
        ...
        self.details_form.setGeometry(QRect(0, 0, 345, 1655))
        ...
        icon1 = QIcon()
        icon1.addFile(u":/icons/util/close_dark.svg", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        icon1.addFile(u":/icons/util/close_grey.svg", QSize(), QIcon.Mode.Disabled, QIcon.State.Off)
        icon1.addFile(u":/icons/util/close_grey.svg", QSize(), QIcon.Mode.Disabled, QIcon.State.On)
        icon1.addFile(u":/icons/util/close_red.svg", QSize(), QIcon.Mode.Active, QIcon.State.Off)
        icon1.addFile(u":/icons/util/close_red.svg", QSize(), QIcon.Mode.Active, QIcon.State.On)
        icon1.addFile(u":/icons/util/close_red.svg", QSize(), QIcon.Mode.Selected, QIcon.State.Off)
        ...
        self.title_label_container.setGeometry(QRect(0, 0, 245, 40))
        ...
        icon2 = QIcon()
        icon2.addFile(u":/icons/util/lock_circle_dark.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon2.addFile(u":/icons/util/edit_dark.svg", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        icon2.addFile(u":/icons/util/lock_circle_grey.svg", QSize(), QIcon.Mode.Disabled, QIcon.State.Off)
        icon2.addFile(u":/icons/util/edit_grey.svg", QSize(), QIcon.Mode.Disabled, QIcon.State.On)
        ...
        self.title_edit_button.setIcon(icon2)
        ...
        self.title_line_edit.setFont(font1)
        ...
        icon3 = QIcon()
        icon3.addFile(u":/icons/util/keyboard_dark.svg", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        icon3.addFile(u":/icons/util/keyboard_grey.svg", QSize(), QIcon.Mode.Disabled, QIcon.State.Off)
        icon3.addFile(u":/icons/util/keyboard_grey.svg", QSize(), QIcon.Mode.Disabled, QIcon.State.On)
        icon3.addFile(u":/icons/util/keyboard_blue.svg", QSize(), QIcon.Mode.Active, QIcon.State.Off)
        icon3.addFile(u":/icons/util/keyboard_blue.svg", QSize(), QIcon.Mode.Active, QIcon.State.On)
        icon3.addFile(u":/icons/util/keyboard_blue.svg", QSize(), QIcon.Mode.Selected, QIcon.State.Off)
        icon3.addFile(u":/icons/util/keyboard_blue.svg", QSize(), QIcon.Mode.Selected, QIcon.State.On)
        self.title_keyboard_button.setIcon(icon3)
        ...
        icon4 = QIcon()
        icon4.addFile(u":/icons/calendar/events/flash_slash_dark.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon4.addFile(u":/icons/calendar/events/flash_dark.svg", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        icon4.addFile(u":/icons/calendar/events/flash_slash_grey.svg", QSize(), QIcon.Mode.Disabled, QIcon.State.Off)
        icon4.addFile(u":/icons/calendar/events/flash_grey.svg", QSize(), QIcon.Mode.Disabled, QIcon.State.On)
        icon4.addFile(u":/icons/calendar/events/flash_slash_yellow.svg", QSize(), QIcon.Mode.Active, QIcon.State.Off)
        icon4.addFile(u":/icons/calendar/events/flash_yellow.svg", QSize(), QIcon.Mode.Active, QIcon.State.On)
        icon4.addFile(u":/icons/calendar/events/flash_slash_yellow.svg", QSize(), QIcon.Mode.Selected, QIcon.State.Off)
        ...
        self.preset = QScrollArea(self.details_form)
        self.preset.setObjectName(u"preset")
        sizePolicy7.setHeightForWidth(self.preset.sizePolicy().hasHeightForWidth())
        self.preset.setSizePolicy(sizePolicy7)
        self.preset.setMinimumSize(QSize(247, 70))
        self.preset.setMaximumSize(QSize(290, 65))
        self.preset.setStyleSheet(u"QScrollBar:horizontal {\n"
"   	background: rgba(40,40,40,0.9);\n"
"    	height: 20px;\n"
"	padding: 0px 25px\n"
"}\n"
...
"	image: url(\":/icons/arrows/arrow_right_red.svg\")\n"
"}")
        self.preset.setFrameShape(QFrame.Shape.NoFrame)
        self.preset.setFrameShadow(QFrame.Shadow.Plain)
        self.preset.setLineWidth(0)
        self.preset.setVerticalScrollBarPolicy(Qt.ScrollBarPolicy.ScrollBarAlwaysOff)
        self.preset.setHorizontalScrollBarPolicy(Qt.ScrollBarPolicy.ScrollBarAlwaysOn)
        self.preset.setSizeAdjustPolicy(QAbstractScrollArea.SizeAdjustPolicy.AdjustToContents)
        self.preset.setWidgetResizable(True)
        self.preset_options = QWidget()
        self.preset_options.setObjectName(u"preset_options")
        self.preset_options.setGeometry(QRect(0, 0, 390, 60))
        self.preset_options_container = QHBoxLayout(self.preset_options)
        self.preset_options_container.setSpacing(10)
        self.preset_options_container.setObjectName(u"preset_options_container")
        self.preset_options_container.setContentsMargins(0, 0, 0, 20)
        self.note_button = QPushButton(self.preset_options)
        ...
        self.note_button.setFont(font2)
        icon5 = QIcon()
        icon5.addFile(u":/icons/calendar/events/message_box_dark.svg", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        icon5.addFile(u":/icons/calendar/events/message_box_grey.svg", QSize(), QIcon.Mode.Disabled, QIcon.State.Off)
        icon5.addFile(u":/icons/calendar/events/message_box_grey.svg", QSize(), QIcon.Mode.Disabled, QIcon.State.On)
        icon5.addFile(u":/icons/calendar/events/message_box_blue.svg", QSize(), QIcon.Mode.Active, QIcon.State.Off)
        icon5.addFile(u":/icons/calendar/events/message_box_blue.svg", QSize(), QIcon.Mode.Active, QIcon.State.On)
        icon5.addFile(u":/icons/calendar/events/message_box_blue.svg", QSize(), QIcon.Mode.Selected, QIcon.State.Off)
        icon5.addFile(u":/icons/calendar/events/message_box_blue.svg", QSize(), QIcon.Mode.Selected, QIcon.State.On)
        self.note_button.setIcon(icon5)
        self.note_button.setIconSize(QSize(20, 20))

        self.preset_options_container.addWidget(self.note_button)

        self.task_button = QPushButton(self.preset_options)
        ...
        self.task_button.setFont(font2)
        icon6 = QIcon()
        icon6.addFile(u":/icons/calendar/events/todo_task_dark.svg", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        icon6.addFile(u":/icons/calendar/events/todo_task_grey.svg", QSize(), QIcon.Mode.Disabled, QIcon.State.Off)
        icon6.addFile(u":/icons/calendar/events/todo_task_grey.svg", QSize(), QIcon.Mode.Disabled, QIcon.State.On)
        icon6.addFile(u":/icons/calendar/events/todo_task_green.svg", QSize(), QIcon.Mode.Active, QIcon.State.Off)
        icon6.addFile(u":/icons/calendar/events/todo_task_green.svg", QSize(), QIcon.Mode.Active, QIcon.State.On)
        icon6.addFile(u":/icons/calendar/events/todo_task_green.svg", QSize(), QIcon.Mode.Selected, QIcon.State.Off)
        icon6.addFile(u":/icons/calendar/events/todo_task_green.svg", QSize(), QIcon.Mode.Selected, QIcon.State.On)
        self.task_button.setIcon(icon6)
        self.task_button.setIconSize(QSize(20, 20))

        self.preset_options_container.addWidget(self.task_button)

        self.simple_button = QPushButton(self.preset_options)
        ...
        self.simple_button.setFont(font2)
        icon7 = QIcon()
        icon7.addFile(u":/icons/calendar/events/other/simple_dark.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon7.addFile(u":/icons/calendar/events/other/simple_grey.svg", QSize(), QIcon.Mode.Disabled, QIcon.State.Off)
        icon7.addFile(u":/icons/calendar/events/other/simple_orange.svg", QSize(), QIcon.Mode.Active, QIcon.State.Off)
        icon7.addFile(u":/icons/calendar/events/other/simple_orange.svg", QSize(), QIcon.Mode.Selected, QIcon.State.Off)
        self.simple_button.setIcon(icon7)
        self.simple_button.setIconSize(QSize(20, 20))

        self.preset_options_container.addWidget(self.simple_button)

        self.other_button = QPushButton(self.preset_options)
        self.other_button.setObjectName(u"other_button")
        sizePolicy7.setHeightForWidth(self.other_button.sizePolicy().hasHeightForWidth())
        self.other_button.setSizePolicy(sizePolicy7)
        self.other_button.setMinimumSize(QSize(110, 40))
        self.other_button.setMaximumSize(QSize(80, 50))
        self.other_button.setFont(font2)
        icon8 = QIcon()
        icon8.addFile(u":/icons/calendar/events/other/complex_dark.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon8.addFile(u":/icons/calendar/events/other/complex_grey.svg", QSize(), QIcon.Mode.Disabled, QIcon.State.On)
        icon8.addFile(u":/icons/calendar/events/other/complex_purple.svg", QSize(), QIcon.Mode.Active, QIcon.State.Off)
        icon8.addFile(u":/icons/calendar/events/other/complex_purple.svg", QSize(), QIcon.Mode.Selected, QIcon.State.Off)
        self.other_button.setIcon(icon8)
        self.other_button.setIconSize(QSize(20, 20))

        self.preset_options_container.addWidget(self.other_button)

        self.preset.setWidget(self.preset_options)

        self.details_form_container.setWidget(1, QFormLayout.FieldRole, self.preset)
        ...
        icon9 = QIcon()
        icon9.addFile(u":/icons/calendar/clock_slash_dark.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon9.addFile(u":/icons/calendar/clock_light.svg", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        icon9.addFile(u":/icons/calendar/clock_slash_grey.svg", QSize(), QIcon.Mode.Disabled, QIcon.State.Off)
        icon9.addFile(u":/icons/calendar/clock_grey.svg", QSize(), QIcon.Mode.Disabled, QIcon.State.On)
        icon9.addFile(u":/icons/calendar/clock_slash_orange.svg", QSize(), QIcon.Mode.Active, QIcon.State.Off)
        icon9.addFile(u":/icons/calendar/clock_orange.svg", QSize(), QIcon.Mode.Active, QIcon.State.On)
        icon9.addFile(u":/icons/calendar/clock_slash_orange.svg", QSize(), QIcon.Mode.Selected, QIcon.State.Off)
        ...
        self.allday_label = QLabel(self.time_edit)
        self.allday_label.setObjectName(u"allday_label")
        self.allday_label.setMinimumSize(QSize(0, 30))
        self.allday_label.setFont(font2)

        self.time_edit_form.setWidget(0, QFormLayout.LabelRole, self.allday_label)

        self.allday_checkbox = QCheckBox(self.time_edit)
        self.allday_checkbox.setObjectName(u"allday_checkbox")
        self.allday_checkbox.setMinimumSize(QSize(30, 30))
        self.allday_checkbox.setMaximumSize(QSize(30, 30))
        self.allday_checkbox.setIconSize(QSize(30, 30))
        self.allday_checkbox.setChecked(False)
        self.allday_checkbox.setTristate(False)

        self.time_edit_form.setWidget(0, QFormLayout.FieldRole, self.allday_checkbox)

        self.start_label = QLabel(self.time_edit)
        self.start_label.setObjectName(u"start_label")
        self.start_label.setMinimumSize(QSize(0, 30))
        self.start_label.setFont(font2)

        self.time_edit_form.setWidget(1, QFormLayout.LabelRole, self.start_label)

        self.start_select = TDateTimeSelect(self.time_edit)
        self.start_select.setObjectName(u"start_select")
        sizePolicy8.setHeightForWidth(self.start_select.sizePolicy().hasHeightForWidth())
        self.start_select.setSizePolicy(sizePolicy8)
        self.start_select.setMinimumSize(QSize(0, 30))
        self.start_select.setAutoFillBackground(False)

        self.time_edit_form.setWidget(1, QFormLayout.FieldRole, self.start_select)

        self.end_label = QLabel(self.time_edit)
        self.end_label.setObjectName(u"end_label")
        self.end_label.setMinimumSize(QSize(0, 30))
        self.end_label.setFont(font2)
        self.end_label.setAlignment(Qt.AlignmentFlag.AlignLeading|Qt.AlignmentFlag.AlignLeft|Qt.AlignmentFlag.AlignVCenter)

        self.time_edit_form.setWidget(3, QFormLayout.LabelRole, self.end_label)

        self.end_select = TDateTimeSelect(self.time_edit)
        self.end_select.setObjectName(u"end_select")
        self.end_select.setMinimumSize(QSize(0, 30))
        self.end_select.setAutoFillBackground(False)

        self.time_edit_form.setWidget(3, QFormLayout.FieldRole, self.end_select)

        self.schedule_label = QLabel(self.time_edit)
        self.schedule_label.setObjectName(u"schedule_label")
        self.schedule_label.setMinimumSize(QSize(0, 30))
        self.schedule_label.setFont(font2)
        ...
        sizePolicy8.setHeightForWidth(self.attributes_button.sizePolicy().hasHeightForWidth())
        self.attributes_button.setSizePolicy(sizePolicy8)
        self.attributes_button.setMinimumSize(QSize(50, 50))
        self.attributes_button.setMaximumSize(QSize(50, 50))
        icon10 = QIcon()
        icon10.addFile(u":/icons/calendar/events/layer_slash_dark.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon10.addFile(u":/icons/calendar/events/layer_dark.svg", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        icon10.addFile(u":/icons/calendar/events/layer_slash_grey.svg", QSize(), QIcon.Mode.Disabled, QIcon.State.Off)
        icon10.addFile(u":/icons/calendar/events/layer_grey.svg", QSize(), QIcon.Mode.Disabled, QIcon.State.On)
        icon10.addFile(u":/icons/calendar/events/layer_slash_blue2.svg", QSize(), QIcon.Mode.Active, QIcon.State.Off)
        icon10.addFile(u":/icons/calendar/events/layer_blue2.svg", QSize(), QIcon.Mode.Active, QIcon.State.On)
        icon10.addFile(u":/icons/calendar/events/layer_slash_blue1.svg", QSize(), QIcon.Mode.Selected, QIcon.State.Off)
        ...
        icon11 = QIcon()
        icon11.addFile(u":/icons/calendar/events/location/location_slash_dark.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon11.addFile(u":/icons/calendar/events/location/location_dark.svg", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        icon11.addFile(u":/icons/calendar/events/location/location_slash_grey.svg", QSize(), QIcon.Mode.Disabled, QIcon.State.Off)
        icon11.addFile(u":/icons/calendar/events/location/location_grey.svg", QSize(), QIcon.Mode.Disabled, QIcon.State.On)
        icon11.addFile(u":/icons/calendar/events/location/location_slash_green.svg", QSize(), QIcon.Mode.Active, QIcon.State.Off)
        icon11.addFile(u":/icons/calendar/events/location/location_green.svg", QSize(), QIcon.Mode.Active, QIcon.State.On)
        icon11.addFile(u":/icons/calendar/events/location/location_slash_green.svg", QSize(), QIcon.Mode.Selected, QIcon.State.Off)
        icon11.addFile(u":/icons/calendar/events/location/location_green.svg", QSize(), QIcon.Mode.Selected, QIcon.State.On)
        self.location_button.setIcon(icon11)
        ...
        icon12 = QIcon()
        icon12.addFile(u":/icons/user/profile_2_slash_light.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon12.addFile(u":/icons/user/profile_2_dark.svg", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        icon12.addFile(u":/icons/user/profile_2_slash_grey.svg", QSize(), QIcon.Mode.Disabled, QIcon.State.Off)
        icon12.addFile(u":/icons/user/profile_2_grey.svg", QSize(), QIcon.Mode.Disabled, QIcon.State.On)
        icon12.addFile(u":/icons/user/profile_2_slash_red.svg", QSize(), QIcon.Mode.Active, QIcon.State.Off)
        icon12.addFile(u":/icons/user/profile_2_red.svg", QSize(), QIcon.Mode.Active, QIcon.State.On)
        icon12.addFile(u":/icons/user/profile_2_slash_orange.svg", QSize(), QIcon.Mode.Selected, QIcon.State.Off)
        icon12.addFile(u":/icons/user/profile_2_orange.svg", QSize(), QIcon.Mode.Selected, QIcon.State.On)
        self.invitees_button.setIcon(icon12)
        ...
        icon13 = QIcon()
        icon13.addFile(u":/icons/calendar/events/tags/tag_slash_dark.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon13.addFile(u":/icons/calendar/events/tags/tag_dark.svg", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        icon13.addFile(u":/icons/calendar/events/tags/tag_slash_grey.svg", QSize(), QIcon.Mode.Disabled, QIcon.State.Off)
        icon13.addFile(u":/icons/calendar/events/tags/tag_grey.svg", QSize(), QIcon.Mode.Disabled, QIcon.State.On)
        icon13.addFile(u":/icons/calendar/events/tags/tag_slash_blue.svg", QSize(), QIcon.Mode.Active, QIcon.State.Off)
        icon13.addFile(u":/icons/calendar/events/tags/tag_blue.svg", QSize(), QIcon.Mode.Active, QIcon.State.On)
        icon13.addFile(u":/icons/calendar/events/tags/tag_slash_blue.svg", QSize(), QIcon.Mode.Selected, QIcon.State.Off)
        icon13.addFile(u":/icons/calendar/events/tags/tag_blue.svg", QSize(), QIcon.Mode.Selected, QIcon.State.On)
        self.tags_button.setIcon(icon13)
        ...
        icon14.addFile(u":/icons/util/alert_yellow.svg", QSize(), QIcon.Mode.Active, QIcon.State.Off)
        icon14.addFile(u":/icons/util/add_2_red.svg", QSize(), QIcon.Mode.Active, QIcon.State.On)
        icon14.addFile(u":/icons/util/alert_yellow.svg", QSize(), QIcon.Mode.Selected, QIcon.State.Off)
        icon14.addFile(u":/icons/util/add_2_red.svg", QSize(), QIcon.Mode.Selected, QIcon.State.On)
        self.save_button.setIcon(icon14)
        ...
        self.location_view_col_label_container.setGeometry(QRect(0, 0, 244, 40))
        sizePolicy7.setHeightForWidth(self.location_view_col_label_container.sizePolicy().hasHeightForWidth())
        self.location_view_col_label_container.setSizePolicy(sizePolicy7)
        ...
        self.address_view_col_label = QLabel(self.location_view_col_label_container)
        self.address_view_col_label.setObjectName(u"address_view_col_label")
        sizePolicy11 = QSizePolicy(QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Fixed)
        sizePolicy11.setHorizontalStretch(0)
        sizePolicy11.setVerticalStretch(0)
        sizePolicy11.setHeightForWidth(self.address_view_col_label.sizePolicy().hasHeightForWidth())
        ...
        icon15 = QIcon()
        icon15.addFile(u":/icons/calendar/events/location/location_lock_dark.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon15.addFile(u":/icons/calendar/events/location/location_edit_dark.svg", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        icon15.addFile(u":/icons/calendar/events/location/location_lock_grey.svg", QSize(), QIcon.Mode.Disabled, QIcon.State.Off)
        icon15.addFile(u":/icons/calendar/events/location/location_edit_grey.svg", QSize(), QIcon.Mode.Disabled, QIcon.State.On)
        icon15.addFile(u":/icons/calendar/events/location/location_lock_red.svg", QSize(), QIcon.Mode.Active, QIcon.State.Off)
        icon15.addFile(u":/icons/calendar/events/location/location_edit_green.svg", QSize(), QIcon.Mode.Active, QIcon.State.On)
        icon15.addFile(u":/icons/calendar/events/location/location_lock_red.svg", QSize(), QIcon.Mode.Selected, QIcon.State.Off)
        icon15.addFile(u":/icons/calendar/events/location/location_edit_green.svg", QSize(), QIcon.Mode.Selected, QIcon.State.On)
        self.location_expand_button.setIcon(icon15)
        ...
        icon16 = QIcon()
        icon16.addFile(u":/icons/calendar/events/location/location_back_dark.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon16.addFile(u":/icons/calendar/events/location/location_tick2_dark.svg", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        icon16.addFile(u":/icons/calendar/events/location/location_back_grey.svg", QSize(), QIcon.Mode.Disabled, QIcon.State.Off)
        icon16.addFile(u":/icons/calendar/events/location/location_tick1_grey.svg", QSize(), QIcon.Mode.Disabled, QIcon.State.On)
        icon16.addFile(u":/icons/calendar/events/location/location_back_dark.svg", QSize(), QIcon.Mode.Active, QIcon.State.Off)
        icon16.addFile(u":/icons/calendar/events/location/location_tick1_dark.svg", QSize(), QIcon.Mode.Active, QIcon.State.On)
        icon16.addFile(u":/icons/calendar/events/location/location_back_blue.svg", QSize(), QIcon.Mode.Selected, QIcon.State.Off)
        icon16.addFile(u":/icons/calendar/events/location/location_tick1_green.svg", QSize(), QIcon.Mode.Selected, QIcon.State.On)
        self.location_finish_button.setIcon(icon16)
        ...
        icon17 = QIcon()
        icon17.addFile(u":/icons/calendar/events/location/location_remove1_dark.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon17.addFile(u":/icons/calendar/events/location/location_add1_dark.svg", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        icon17.addFile(u":/icons/calendar/events/location/location_remove1_grey.svg", QSize(), QIcon.Mode.Disabled, QIcon.State.Off)
        icon17.addFile(u":/icons/calendar/events/location/location_add1_grey.svg", QSize(), QIcon.Mode.Disabled, QIcon.State.On)
        icon17.addFile(u":/icons/calendar/events/location/location_remove1_red.svg", QSize(), QIcon.Mode.Active, QIcon.State.Off)
        icon17.addFile(u":/icons/calendar/events/location/location_add1_green1.svg", QSize(), QIcon.Mode.Active, QIcon.State.On)
        self.location_edit_button.setIcon(icon17)
        ...
        sizePolicy12.setHeightForWidth(self.attribute_view_edit_toggle.sizePolicy().hasHeightForWidth())
        self.attribute_view_edit_toggle.setSizePolicy(sizePolicy12)
        ...
        self.attribute_view_edit_toggle.setFont(font2)
        self.attribute_view_edit_toggle.setLayoutDirection(Qt.LayoutDirection.LeftToRight)
        self.attribute_view_edit_toggle.setIcon(icon2)
...
"}")
        ...
        self.layer_header.setGeometry(QRect(-195, 0, 480, 60))
        ...
        self.layer_finish_button.setFont(font2)
        icon18 = QIcon()
        icon18.addFile(u":/icons/util/back_square1_dark.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon18.addFile(u":/icons/util/back_square1_grey.svg", QSize(), QIcon.Mode.Disabled, QIcon.State.Off)
        icon18.addFile(u":/icons/util/back_square1_blue.svg", QSize(), QIcon.Mode.Active, QIcon.State.Off)
        icon18.addFile(u":/icons/util/back_square1_blue.svg", QSize(), QIcon.Mode.Selected, QIcon.State.Off)
        self.layer_finish_button.setIcon(icon18)
        ...
        self.layer_remove_button.setFont(font2)
        icon20 = QIcon()
        icon20.addFile(u":/icons/util/minus_square_dark.svg", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        icon20.addFile(u":/icons/util/minus_square_grey.svg", QSize(), QIcon.Mode.Disabled, QIcon.State.Off)
        icon20.addFile(u":/icons/util/minus_square_grey.svg", QSize(), QIcon.Mode.Disabled, QIcon.State.On)
        icon20.addFile(u":/icons/util/minus_square_red.svg", QSize(), QIcon.Mode.Active, QIcon.State.Off)
        icon20.addFile(u":/icons/util/minus_square_red.svg", QSize(), QIcon.Mode.Active, QIcon.State.On)
        icon20.addFile(u":/icons/util/minus_square_red.svg", QSize(), QIcon.Mode.Selected, QIcon.State.Off)
        icon20.addFile(u":/icons/util/minus_square_red.svg", QSize(), QIcon.Mode.Selected, QIcon.State.On)
        self.layer_remove_button.setIcon(icon20)
        ...
        self.layer_edit_button.setFont(font2)
        icon21 = QIcon()
        icon21.addFile(u":/icons/util/edit_dark.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon21.addFile(u":/icons/util/edit_grey.svg", QSize(), QIcon.Mode.Disabled, QIcon.State.Off)
        icon21.addFile(u":/icons/util/edit_blue.svg", QSize(), QIcon.Mode.Active, QIcon.State.Off)
        icon21.addFile(u":/icons/util/edit_blue.svg", QSize(), QIcon.Mode.Selected, QIcon.State.Off)
        self.layer_edit_button.setIcon(icon21)
        ...
        self.layer_move_button.setFont(font2)
        icon22 = QIcon()
        icon22.addFile(u":/icons/util/move_square1_dark.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon22.addFile(u":/icons/util/move_square1_grey.svg", QSize(), QIcon.Mode.Disabled, QIcon.State.Off)
        icon22.addFile(u":/icons/util/move_square1_blue.svg", QSize(), QIcon.Mode.Active, QIcon.State.Off)
        icon22.addFile(u":/icons/util/move_square1_blue.svg", QSize(), QIcon.Mode.Selected, QIcon.State.Off)
        self.layer_move_button.setIcon(icon22)
        ...
        self.layer_save_changes_button.setFont(font2)
        icon23 = QIcon()
        icon23.addFile(u":/icons/util/tick_square1_dark.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon23.addFile(u":/icons/util/tick_square1_grey.svg", QSize(), QIcon.Mode.Disabled, QIcon.State.Off)
        icon23.addFile(u":/icons/util/tick_square1_green.svg", QSize(), QIcon.Mode.Active, QIcon.State.Off)
        icon23.addFile(u":/icons/util/tick_square1_green.svg", QSize(), QIcon.Mode.Selected, QIcon.State.Off)
        self.layer_save_changes_button.setIcon(icon23)
        ...
        self.layer_cancel_changes_button.setFont(font2)
        icon24 = QIcon()
        icon24.addFile(u":/icons/util/close_square1_dark.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon24.addFile(u":/icons/util/close_square1_grey.svg", QSize(), QIcon.Mode.Disabled, QIcon.State.Off)
        icon24.addFile(u":/icons/util/close_square1_red.svg", QSize(), QIcon.Mode.Active, QIcon.State.Off)
        icon24.addFile(u":/icons/util/close_square1_red.svg", QSize(), QIcon.Mode.Selected, QIcon.State.Off)
        self.layer_cancel_changes_button.setIcon(icon24)
...
"}")
        ...
        self.layer_header_exp_add.setGeometry(QRect(0, 0, 285, 40))
        ...
        self.layer_add_task_button.setFont(font2)
        icon25 = QIcon()
        icon25.addFile(u":/icons/calendar/events/description/description_add_dark.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon25.addFile(u":/icons/calendar/events/description/description_add_grey.svg", QSize(), QIcon.Mode.Disabled, QIcon.State.Off)
        icon25.addFile(u":/icons/calendar/events/description/description_add_blue.svg", QSize(), QIcon.Mode.Active, QIcon.State.Off)
        icon25.addFile(u":/icons/calendar/events/description/description_add_blue.svg", QSize(), QIcon.Mode.Selected, QIcon.State.Off)
        self.layer_add_task_button.setIcon(icon25)
        ...
        self.layer_add_note_button.setFont(font2)
        icon26 = QIcon()
        icon26.addFile(u":/icons/calendar/events/todo/todo_add_dark.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon26.addFile(u":/icons/calendar/events/todo/todo_add_grey.svg", QSize(), QIcon.Mode.Disabled, QIcon.State.Off)
        icon26.addFile(u":/icons/calendar/events/todo/todo_add_green.svg", QSize(), QIcon.Mode.Active, QIcon.State.Off)
        icon26.addFile(u":/icons/calendar/events/todo/todo_add_green.svg", QSize(), QIcon.Mode.Selected, QIcon.State.Off)
        self.layer_add_note_button.setIcon(icon26)
        ...
        sizePolicy13.setHeightForWidth(self.task_line_edit.sizePolicy().hasHeightForWidth())
        self.task_line_edit.setSizePolicy(sizePolicy13)
        self.task_line_edit.setMinimumSize(QSize(212, 40))
        self.task_line_edit.setMaximumSize(QSize(250, 40))
        self.task_line_edit.setFont(font1)
        ...
        self.task_keyboard_button.setIcon(icon3)
        ...
        self.task_checkbox.setFont(font2)
        ...
        sizePolicy14.setHeightForWidth(self.task_edit_confirm.sizePolicy().hasHeightForWidth())
        self.task_edit_confirm.setSizePolicy(sizePolicy14)
        self.task_edit_confirm.setMinimumSize(QSize(90, 40))
        self.task_edit_confirm.setMaximumSize(QSize(90, 40))
        self.task_edit_confirm.setFont(font2)
...
"}")
        ...
        self.bold_selected.setFont(font2)
        icon27 = QIcon()
        icon27.addFile(u":/icons/util/text/text_bold_dark.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon27.addFile(u":/icons/util/text/text_bold_grey.svg", QSize(), QIcon.Mode.Disabled, QIcon.State.Off)
        self.bold_selected.setIcon(icon27)
        ...
        self.underline_selected.setFont(font2)
        icon28 = QIcon()
        icon28.addFile(u":/icons/util/text/text_underline_dark.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon28.addFile(u":/icons/util/text/text_underline_grey.svg", QSize(), QIcon.Mode.Disabled, QIcon.State.Off)
        self.underline_selected.setIcon(icon28)
        ...
        self.italicise_selected.setFont(font2)
        icon29 = QIcon()
        icon29.addFile(u":/icons/util/text/text_italic_dark.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon29.addFile(u":/icons/util/text/text_italic_grey.svg", QSize(), QIcon.Mode.Disabled, QIcon.State.Off)
        self.italicise_selected.setIcon(icon29)
        ...
        sizePolicy15.setHeightForWidth(self.layer_note_text_edit.sizePolicy().hasHeightForWidth())
        self.layer_note_text_edit.setSizePolicy(sizePolicy15)
        self.layer_note_text_edit.setMinimumSize(QSize(247, 0))
        self.layer_note_text_edit.setMaximumSize(QSize(290, 16777215))
        self.layer_note_text_edit.setFont(font2)
        ...
        self.undo_button.setFont(font2)
        icon30 = QIcon()
        icon30.addFile(u":/icons/arrows/arrow_redo_dark.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon30.addFile(u":/icons/arrows/arrow_redo_grey.svg", QSize(), QIcon.Mode.Disabled, QIcon.State.Off)
        icon30.addFile(u":/icons/arrows/arrow_redo_blue.svg", QSize(), QIcon.Mode.Active, QIcon.State.Off)
        icon30.addFile(u":/icons/arrows/arrow_redo_blue.svg", QSize(), QIcon.Mode.Selected, QIcon.State.Off)
        self.undo_button.setIcon(icon30)
        ...
        self.redo_button.setFont(font2)
        icon31 = QIcon()
        icon31.addFile(u":/icons/arrows/arrow_undo_dark.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon31.addFile(u":/icons/arrows/arrow_undo_grey.svg", QSize(), QIcon.Mode.Disabled, QIcon.State.Off)
        icon31.addFile(u":/icons/arrows/arrow_undo_blue.svg", QSize(), QIcon.Mode.Active, QIcon.State.Off)
        icon31.addFile(u":/icons/arrows/arrow_undo_blue.svg", QSize(), QIcon.Mode.Selected, QIcon.State.Off)
        self.redo_button.setIcon(icon31)
        ...
        self.note_edit_confirm.setFont(font2)
        ...
        self.details_container.setCurrentIndex(2)
    ...
    def retranslateUi(self, event_view):
        ...
        self.allday_label.setText(QCoreApplication.translate("event_view", u"All-day", None))
        self.allday_checkbox.setText("")
        ...
        self.address_view_col_label.setText(QCoreApplication.translate("event_view", u"Address", None))
        self.location_expand_button.setText("")
        self.address_line_1_label.setText(QCoreApplication.translate("event_view", u"add_line_1", None))
        self.address_line_2_label.setText(QCoreApplication.translate("event_view", u"add_line_2", None))
        self.address_line_3_label.setText(QCoreApplication.translate("event_view", u"add_line_3", None))
        self.county_label.setText(QCoreApplication.translate("event_view", u"county", None))
        self.city_label.setText(QCoreApplication.translate("event_view", u"city", None))
        self.postcode_label.setText(QCoreApplication.translate("event_view", u"postcode", None))
